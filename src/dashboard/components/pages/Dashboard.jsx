import { AdjustmentsVerticalIcon, ClipboardDocumentCheckIcon, CubeIcon, FolderIcon, RocketLaunchIcon, SparklesIcon, SquaresPlusIcon } from '@heroicons/react/20/solid';
...
const features = [
    {
        name: 'PHP Autoloader',
        description:
            'Music_Slider uses Composer to autoload your PHP files and namespaces all without having to manually to include/require them.',
        icon: FolderIcon,
    },
    {
    ...
    },
    {
        ...
        description: 'Music_Slider uses wp-scripts under the hood to give you the latest and greatest of WordPress Block Development.',
        icon: CubeIcon,
    },
    {
