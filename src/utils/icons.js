...
export const mdSkipNext= <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 24 24" height="1em" width="1em"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z" /></svg>;

export const mdSkipPrevious= <svg stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 24 24" height="1em" width="1em" ><path d="M6 6h2v12H6zm3.5 6l8.5 6V6z" /></svg>;
